...
<html lang="es">
    <head>
        ...
        <title> Techno shop - Registro de vendedor</title>
                        ...
                        <section class="full-box page-content">
                            ...
                            <div class="container-fluid">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="form-floating col-12 col-md-12">
                                                <div>
                                                    <label for=""> <b>Subir soporte de identificacion</b> </label>
                                                </div>
                                            ...
                                            <div class="form-floating col-12 col-md-6">
                                                <select class="form-control rounded-3" id="ProductProvider">
                                                    ...
                                                    <option value="">Judirica</option>
                                                </select>
                                            </div>
                                            <div class="form-floating col-12 col-md-6">
                                                <input type="text" class="form-control" id="floatingInput" maxlength="10">
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn btn-primary"> <i class="fas fa-check"></i> Continuar</button>
